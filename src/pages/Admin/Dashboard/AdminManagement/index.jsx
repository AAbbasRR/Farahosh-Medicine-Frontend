...
const AdminManagement = () => {
	...
	const getData = () => {
		...
		axios
			.get("/admin/user/manage/admin/list_create/", {
	...
	const deleteAdmin = (id) => {
		axios
			.delete("/admin/user/manage/admin/update_delete/", {
				params: { pk: id },
			})
			.then((res) => {
				getData();
	...
	const columns = [
		...
		},
		{
			...
			renderCell: ({ row }) => (
				<img
					...
					src={row?.is_staff ? IconSuccess : IconDanger}
					alt="is_staff_status"
				/>
			),
		},
		{
			...
			renderCell: ({ row }) => (
				<img
					className={style.roleChips}
					src={row?.is_superuser ? IconSuccess : IconDanger}
					alt="is_superuser_status"
				/>
			),
		},
		{
