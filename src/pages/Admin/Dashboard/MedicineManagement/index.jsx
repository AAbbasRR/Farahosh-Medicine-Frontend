...
const MedicineManagement = () => {
	...
	const columns = [
		...
		},
		{
			...
			field: "price_exchange_subsidy",
			flex: 1,
			sortable: false,
			renderCell: ({ row }) => row?.price_exchange_subsidy.toLocaleString(),
		},
		{
			headerName: "درصد سهم سازمان",
			field: "percent_share_of_organization_exchange_subsidy",
			flex: 1,
			sortable: false,
		},
		{
					...
					<div className={`${style.history} ${"active"}`}>
						<div className={style.header}>
							<div className={style.header__title}>
								<div className={style.title}>مدیریت دارو ها</div>
